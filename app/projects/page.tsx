        ...
        <main className="h-screen flex flex-col overflow-hidden">
             <div className="flex flex-row justify-content p-10 w-screen">
                ...
                <div className="flex flex-row p-10 h-screen ">
                    <div className="flex w-3/12 justify-content align-items max-h-screen">  
                    ...
                    <div className="flex flex-col flex-grow overflow-y-auto space-y-1 hide-scrollbar mb-20">
                        <Link target="_blank" href="https://books-around-the-world-d3562b9f2c4c.herokuapp.com/" rel="noopener noreferrer">
                        <div className='text-9xl font-serif hover:italic'> GlobeBook
                        ...
                        <Link target="_blank" href="https://22ashah.wixsite.com/seniorproject/news" rel="noopener noreferrer">
                            <div className='text-9xl font-serif hover:italic'> Data Visualization
                        ...
                        <Link target="_blank" href="https://arxiv.org/abs/2312.03020" rel="noopener noreferrer">
                            <div className='text-9xl font-serif hover:italic'> ML Research Paper
                        ...
                        <div className='text-9xl font-serif hover:italic'> World Quiz
                            <div className="text-xl space-y-20 ml-5 mt-5">
